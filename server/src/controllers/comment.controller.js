...
const updateComment = asyncHandler(async (req, res) => {
  ...
  if (!comment) {
    throw new ApiError(
      404,
      "Comment not found or User is not authorized :: updateComment, comment.controller"
    );
  }
...
const deleteComment = asyncHandler(async (req, res) => {
  ...
  if (!comment) {
    throw new ApiError(
      404,
      "Comment not found or user is not authorized :: deleteComment, comment.controller"
    );
  }
